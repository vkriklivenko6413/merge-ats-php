 ...
 */
class PaginatedAccountDetailsAndActionsList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaginatedAccountDetailsAndActionsList';
