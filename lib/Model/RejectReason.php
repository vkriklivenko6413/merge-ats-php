 ...
 */
class RejectReason implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RejectReason';
     ...
     * Sets name
     *
     * @param string|null $name The rejection reason’s name.
     *
     * @return self
     */
