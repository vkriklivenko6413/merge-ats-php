...
/**
 * RemoteUserRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class RemoteUserRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RemoteUserRequest';
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 254)) {
            throw new \InvalidArgumentException('invalid length for $email when calling RemoteUserRequest., must be smaller than or equal to 254.');
        }
