...
class ConditionSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'field_name' => 'string',
        'is_unique' => 'bool',
        'condition_type' => '\MergeATSClient\Model\ConditionTypeEnum',
        'operators' => '\MergeATSClient\Model\OperatorSchema[]'
    ];
     ...
     * Gets condition_type
     *
     * @return \MergeATSClient\Model\ConditionTypeEnum
     */
     ...
     * Sets condition_type
     *
     * @param \MergeATSClient\Model\ConditionTypeEnum $condition_type condition_type
     *
     * @return self
     */
     ...
     * Gets operators
     *
     * @return \MergeATSClient\Model\OperatorSchema[]
     */
     ...
     * Sets operators
     *
     * @param \MergeATSClient\Model\OperatorSchema[] $operators The schemas for the operators that can be used on a condition.
     *
     * @return self
     */
