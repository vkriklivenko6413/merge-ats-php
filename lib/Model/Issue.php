...
class Issue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'status' => '\MergeATSClient\Model\IssueStatusEnum',
     ...
     * Gets status
     *
     * @return \MergeATSClient\Model\IssueStatusEnum|null
     */
     ...
     * Sets status
     *
     * @param \MergeATSClient\Model\IssueStatusEnum|null $status status
     *
     * @return self
     */
