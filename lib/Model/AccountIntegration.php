...
class AccountIntegration implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets categories
     *
     * @return \MergeATSClient\Model\CategoriesEnum[]|null
     */
     ...
     * Sets categories
     *
     * @param \MergeATSClient\Model\CategoriesEnum[]|null $categories Category or categories this integration belongs to. Multiple categories should be comma separated.<br/><br>Example: For [ats, hris], enter <i>ats,hris</i>
     *
     * @return self
     */
