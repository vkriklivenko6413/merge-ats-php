 ...
 */
class EmailAddressRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailAddressRequest';
    ...
    {
        if (!is_null($value) && (mb_strlen($value) > 254)) {
            throw new \InvalidArgumentException('invalid length for $value when calling EmailAddressRequest., must be smaller than or equal to 254.');
        }
