...
class TagsApi
{
     ...
     * @return \MergeATSClient\Model\PaginatedTagList
     */
    public function tagsList($x_account_token, $created_after = null, $created_before = null, $cursor = null, $include_deleted_data = null, $include_remote_data = null, $modified_after = null, $modified_before = null, $page_size = null, $remote_id = null)
    {
        list($response) = $this->tagsListWithHttpInfo($x_account_token, $created_after, $created_before, $cursor, $include_deleted_data, $include_remote_data, $modified_after, $modified_before, $page_size, $remote_id);
        return $response;
    }
     ...
     * @throws \MergeATSClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MergeATSClient\Model\PaginatedTagList, HTTP status code, HTTP response headers (array of strings)
     */
    public function tagsListWithHttpInfo($x_account_token, $created_after = null, $created_before = null, $cursor = null, $include_deleted_data = null, $include_remote_data = null, $modified_after = null, $modified_before = null, $page_size = null, $remote_id = null)
    {
        $request = $this->tagsListRequest($x_account_token, $created_after, $created_before, $cursor, $include_deleted_data, $include_remote_data, $modified_after, $modified_before, $page_size, $remote_id);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MergeATSClient\Model\PaginatedTagList' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MergeATSClient\Model\PaginatedTagList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MergeATSClient\Model\PaginatedTagList';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MergeATSClient\Model\PaginatedTagList',
     ...
     */
    public function tagsListAsync($x_account_token, $created_after = null, $created_before = null, $cursor = null, $include_deleted_data = null, $include_remote_data = null, $modified_after = null, $modified_before = null, $page_size = null, $remote_id = null)
    {
        return $this->tagsListAsyncWithHttpInfo($x_account_token, $created_after, $created_before, $cursor, $include_deleted_data, $include_remote_data, $modified_after, $modified_before, $page_size, $remote_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tagsListAsyncWithHttpInfo($x_account_token, $created_after = null, $created_before = null, $cursor = null, $include_deleted_data = null, $include_remote_data = null, $modified_after = null, $modified_before = null, $page_size = null, $remote_id = null)
    {
        $returnType = '\MergeATSClient\Model\PaginatedTagList';
        $request = $this->tagsListRequest($x_account_token, $created_after, $created_before, $cursor, $include_deleted_data, $include_remote_data, $modified_after, $modified_before, $page_size, $remote_id);
     ...
     */
    public function tagsListRequest($x_account_token, $created_after = null, $created_before = null, $cursor = null, $include_deleted_data = null, $include_remote_data = null, $modified_after = null, $modified_before = null, $page_size = null, $remote_id = null)
    {
        // verify the required parameter 'x_account_token' is set
        if ($x_account_token === null || (is_array($x_account_token) && count($x_account_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_account_token when calling tagsList'
            );
        }
