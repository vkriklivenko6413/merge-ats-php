...
class ActivitiesApi
{
     ...
     */
    public function activitiesList($x_account_token, $created_after = null, $created_before = null, $cursor = null, $include_deleted_data = null, $include_remote_data = null, $modified_after = null, $modified_before = null, $page_size = null, $remote_fields = null, $remote_id = null, $user_id = null)
    {
        list($response) = $this->activitiesListWithHttpInfo($x_account_token, $created_after, $created_before, $cursor, $include_deleted_data, $include_remote_data, $modified_after, $modified_before, $page_size, $remote_fields, $remote_id, $user_id);
        return $response;
    }

    /**
     * Operation activitiesListWithHttpInfo
     *
     * @param  string $x_account_token Token identifying the end user. (required)
     * @param  \DateTime $created_after If provided, will only return objects created after this datetime. (optional)
     * @param  \DateTime $created_before If provided, will only return objects created before this datetime. (optional)
     ...
     */
    public function activitiesListWithHttpInfo($x_account_token, $created_after = null, $created_before = null, $cursor = null, $include_deleted_data = null, $include_remote_data = null, $modified_after = null, $modified_before = null, $page_size = null, $remote_fields = null, $remote_id = null, $user_id = null)
    {
        $request = $this->activitiesListRequest($x_account_token, $created_after, $created_before, $cursor, $include_deleted_data, $include_remote_data, $modified_after, $modified_before, $page_size, $remote_fields, $remote_id, $user_id);
     ...
     */
    public function activitiesListAsync($x_account_token, $created_after = null, $created_before = null, $cursor = null, $include_deleted_data = null, $include_remote_data = null, $modified_after = null, $modified_before = null, $page_size = null, $remote_fields = null, $remote_id = null, $user_id = null)
    {
        return $this->activitiesListAsyncWithHttpInfo($x_account_token, $created_after, $created_before, $cursor, $include_deleted_data, $include_remote_data, $modified_after, $modified_before, $page_size, $remote_fields, $remote_id, $user_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation activitiesListAsyncWithHttpInfo
     *
     * @param  string $x_account_token Token identifying the end user. (required)
     * @param  \DateTime $created_after If provided, will only return objects created after this datetime. (optional)
     * @param  \DateTime $created_before If provided, will only return objects created before this datetime. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function activitiesListAsyncWithHttpInfo($x_account_token, $created_after = null, $created_before = null, $cursor = null, $include_deleted_data = null, $include_remote_data = null, $modified_after = null, $modified_before = null, $page_size = null, $remote_fields = null, $remote_id = null, $user_id = null)
    {
        $returnType = '\MergeATSClient\Model\PaginatedActivityList';
        $request = $this->activitiesListRequest($x_account_token, $created_after, $created_before, $cursor, $include_deleted_data, $include_remote_data, $modified_after, $modified_before, $page_size, $remote_fields, $remote_id, $user_id);
    ...
    /**
     * Create request for operation 'activitiesList'
     *
     * @param  string $x_account_token Token identifying the end user. (required)
     * @param  \DateTime $created_after If provided, will only return objects created after this datetime. (optional)
     * @param  \DateTime $created_before If provided, will only return objects created before this datetime. (optional)
     ...
     */
    public function activitiesListRequest($x_account_token, $created_after = null, $created_before = null, $cursor = null, $include_deleted_data = null, $include_remote_data = null, $modified_after = null, $modified_before = null, $page_size = null, $remote_fields = null, $remote_id = null, $user_id = null)
    {
        // verify the required parameter 'x_account_token' is set
        if ($x_account_token === null || (is_array($x_account_token) && count($x_account_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_account_token when calling activitiesList'
            );
        }
     ...
     */
    public function activitiesRetrieve($x_account_token, $id, $include_remote_data = null, $remote_fields = null)
    {
        list($response) = $this->activitiesRetrieveWithHttpInfo($x_account_token, $id, $include_remote_data, $remote_fields);
        return $response;
    }

    /**
     * Operation activitiesRetrieveWithHttpInfo
     *
     * @param  string $x_account_token Token identifying the end user. (required)
     ...
     */
    public function activitiesRetrieveWithHttpInfo($x_account_token, $id, $include_remote_data = null, $remote_fields = null)
    {
        $request = $this->activitiesRetrieveRequest($x_account_token, $id, $include_remote_data, $remote_fields);
    ...
    /**
     * Operation activitiesRetrieveAsync
     *
     * @param  string $x_account_token Token identifying the end user. (required)
     * @param  string $id (required)
     * @param  bool $include_remote_data Whether to include the original data Merge fetched from the third-party to produce these models. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function activitiesRetrieveAsync($x_account_token, $id, $include_remote_data = null, $remote_fields = null)
    {
        return $this->activitiesRetrieveAsyncWithHttpInfo($x_account_token, $id, $include_remote_data, $remote_fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation activitiesRetrieveAsyncWithHttpInfo
     *
     * @param  string $x_account_token Token identifying the end user. (required)
     * @param  string $id (required)
     * @param  bool $include_remote_data Whether to include the original data Merge fetched from the third-party to produce these models. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function activitiesRetrieveAsyncWithHttpInfo($x_account_token, $id, $include_remote_data = null, $remote_fields = null)
    {
        $returnType = '\MergeATSClient\Model\Activity';
        $request = $this->activitiesRetrieveRequest($x_account_token, $id, $include_remote_data, $remote_fields);
    ...
    /**
     * Create request for operation 'activitiesRetrieve'
     *
     * @param  string $x_account_token Token identifying the end user. (required)
     * @param  string $id (required)
     * @param  bool $include_remote_data Whether to include the original data Merge fetched from the third-party to produce these models. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function activitiesRetrieveRequest($x_account_token, $id, $include_remote_data = null, $remote_fields = null)
    {
        // verify the required parameter 'x_account_token' is set
        if ($x_account_token === null || (is_array($x_account_token) && count($x_account_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_account_token when calling activitiesRetrieve'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling activitiesRetrieve'
            );
        }
