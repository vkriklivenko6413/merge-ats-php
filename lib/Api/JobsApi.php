...
class JobsApi
{
     ...
     * @param  string $code If provided, will only return jobs with this code. (optional)
     ...
     */
    public function jobsList($x_account_token, $code = null, $created_after = null, $created_before = null, $cursor = null, $include_deleted_data = null, $include_remote_data = null, $modified_after = null, $modified_before = null, $page_size = null, $remote_fields = null, $remote_id = null, $status = null)
    {
        list($response) = $this->jobsListWithHttpInfo($x_account_token, $code, $created_after, $created_before, $cursor, $include_deleted_data, $include_remote_data, $modified_after, $modified_before, $page_size, $remote_fields, $remote_id, $status);
        return $response;
    }
     ...
     */
    public function jobsListWithHttpInfo($x_account_token, $code = null, $created_after = null, $created_before = null, $cursor = null, $include_deleted_data = null, $include_remote_data = null, $modified_after = null, $modified_before = null, $page_size = null, $remote_fields = null, $remote_id = null, $status = null)
    {
        $request = $this->jobsListRequest($x_account_token, $code, $created_after, $created_before, $cursor, $include_deleted_data, $include_remote_data, $modified_after, $modified_before, $page_size, $remote_fields, $remote_id, $status);
     ...
     */
    public function jobsListAsync($x_account_token, $code = null, $created_after = null, $created_before = null, $cursor = null, $include_deleted_data = null, $include_remote_data = null, $modified_after = null, $modified_before = null, $page_size = null, $remote_fields = null, $remote_id = null, $status = null)
    {
        return $this->jobsListAsyncWithHttpInfo($x_account_token, $code, $created_after, $created_before, $cursor, $include_deleted_data, $include_remote_data, $modified_after, $modified_before, $page_size, $remote_fields, $remote_id, $status)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function jobsListAsyncWithHttpInfo($x_account_token, $code = null, $created_after = null, $created_before = null, $cursor = null, $include_deleted_data = null, $include_remote_data = null, $modified_after = null, $modified_before = null, $page_size = null, $remote_fields = null, $remote_id = null, $status = null)
    {
        $returnType = '\MergeATSClient\Model\PaginatedJobList';
        $request = $this->jobsListRequest($x_account_token, $code, $created_after, $created_before, $cursor, $include_deleted_data, $include_remote_data, $modified_after, $modified_before, $page_size, $remote_fields, $remote_id, $status);
     ...
     */
    public function jobsListRequest($x_account_token, $code = null, $created_after = null, $created_before = null, $cursor = null, $include_deleted_data = null, $include_remote_data = null, $modified_after = null, $modified_before = null, $page_size = null, $remote_fields = null, $remote_id = null, $status = null)
    {
        // verify the required parameter 'x_account_token' is set
        if ($x_account_token === null || (is_array($x_account_token) && count($x_account_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_account_token when calling jobsList'
            );
        }
     ...
     */
    public function jobsRetrieve($x_account_token, $id, $include_remote_data = null, $remote_fields = null)
    {
        list($response) = $this->jobsRetrieveWithHttpInfo($x_account_token, $id, $include_remote_data, $remote_fields);
        return $response;
    }

    /**
     * Operation jobsRetrieveWithHttpInfo
     *
     * @param  string $x_account_token Token identifying the end user. (required)
     ...
     */
    public function jobsRetrieveWithHttpInfo($x_account_token, $id, $include_remote_data = null, $remote_fields = null)
    {
        $request = $this->jobsRetrieveRequest($x_account_token, $id, $include_remote_data, $remote_fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function jobsRetrieveAsync($x_account_token, $id, $include_remote_data = null, $remote_fields = null)
    {
        return $this->jobsRetrieveAsyncWithHttpInfo($x_account_token, $id, $include_remote_data, $remote_fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation jobsRetrieveAsyncWithHttpInfo
     *
     * @param  string $x_account_token Token identifying the end user. (required)
     * @param  string $id (required)
     * @param  bool $include_remote_data Whether to include the original data Merge fetched from the third-party to produce these models. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function jobsRetrieveAsyncWithHttpInfo($x_account_token, $id, $include_remote_data = null, $remote_fields = null)
    {
        $returnType = '\MergeATSClient\Model\Job';
        $request = $this->jobsRetrieveRequest($x_account_token, $id, $include_remote_data, $remote_fields);
    ...
    /**
     * Create request for operation 'jobsRetrieve'
     *
     * @param  string $x_account_token Token identifying the end user. (required)
     * @param  string $id (required)
     * @param  bool $include_remote_data Whether to include the original data Merge fetched from the third-party to produce these models. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function jobsRetrieveRequest($x_account_token, $id, $include_remote_data = null, $remote_fields = null)
    {
        // verify the required parameter 'x_account_token' is set
        if ($x_account_token === null || (is_array($x_account_token) && count($x_account_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_account_token when calling jobsRetrieve'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling jobsRetrieve'
            );
        }
