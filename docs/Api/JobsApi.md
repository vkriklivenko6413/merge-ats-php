...
```php
jobsList($x_account_token, $code, $created_after, $created_before, $cursor, $include_deleted_data, $include_remote_data, $modified_after, $modified_before, $page_size, $remote_fields, $remote_id, $status): \MergeATSClient\Model\PaginatedJobList
```
...
try {
    $result = $apiInstance->jobsList($x_account_token, $code, $created_after, $created_before, $cursor, $include_deleted_data, $include_remote_data, $modified_after, $modified_before, $page_size, $remote_fields, $remote_id, $status);
    print_r($result);
} catch (Exception $e) {
...
```php
jobsRetrieve($x_account_token, $id, $include_remote_data, $remote_fields): \MergeATSClient\Model\Job
```
...
try {
    $result = $apiInstance->jobsRetrieve($x_account_token, $id, $include_remote_data, $remote_fields);
    print_r($result);
} catch (Exception $e) {
