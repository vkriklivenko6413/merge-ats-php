...
```php
syncStatusResyncCreate($x_account_token): \MergeATSClient\Model\SyncStatus[]
```
...
$apiInstance = new MergeATSClient\Api\ForceResyncApi(
...
[**\MergeATSClient\Model\SyncStatus[]**](../Model/SyncStatus.md)
