...
```php
offersList($x_account_token, $application_id, $created_after, $created_before, $creator_id, $cursor, $expand, $include_remote_data, $modified_after, $modified_before, $page_size, $remote_id): \MergeHRISClient\Model\PaginatedOfferList
```
...
try {
    $result = $apiInstance->offersList($x_account_token, $application_id, $created_after, $created_before, $creator_id, $cursor, $expand, $include_remote_data, $modified_after, $modified_before, $page_size, $remote_id);
    print_r($result);
} catch (Exception $e) {
...
```php
offersRetrieve($x_account_token, $id, $expand, $include_remote_data): \MergeHRISClient\Model\Offer
```
...
try {
    $result = $apiInstance->offersRetrieve($x_account_token, $id, $expand, $include_remote_data);
    print_r($result);
} catch (Exception $e) {
