...
$apiInstance = new MergeATSClient\Api\ActivitiesApi(
...
[**\MergeATSClient\Model\PaginatedActivityList**](../Model/PaginatedActivityList.md)
...
[**\MergeATSClient\Model\Activity**](../Model/Activity.md)
