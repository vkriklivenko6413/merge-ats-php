...
try {
    $result = $apiInstance->usersList($x_account_token, $created_after, $created_before, $cursor, $email, $include_remote_data, $modified_after, $modified_before, $page_size, $remote_id);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->usersRetrieve($x_account_token, $id, $include_remote_data);
    print_r($result);
} catch (Exception $e) {
